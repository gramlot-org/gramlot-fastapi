...
[Concise counterpart](https://github.com/gramlot-org/gramlot-fastapi/blob/main/docs_llm/documentation.md).
...
The paired set is overview, architecture, documentation, release and Read the Docs setup. Older API
